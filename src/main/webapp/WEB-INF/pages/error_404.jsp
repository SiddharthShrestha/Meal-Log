...
<head>
  ...
  <title>MealLog — Page Not Found</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .error-icon svg { width: 30px; height: 30px; stroke: var(--green); fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
...
<div class="wrapper">
  ...
  <div class="card">
    ...
    <div class="error-icon">
      <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="11"/><line x1="11" y1="14" x2="11.01" y2="14"/></svg>
    </div>
    <div class="error-title">Page Not Found</div>
    <div class="error-msg">
      The page you are looking for doesn't exist or has been moved.<br/>
      Please check the URL or head back to the application.
    </div>
    <div class="btn-group">
